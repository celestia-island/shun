...
const zhHans: InstallerStrings = {
  ...
  install: {
    preparing: "正在准备安装…",
    startedLog: "开始安装",
    fallback: "正在安装 %PRODUCT%，这可能需要一点时间…",
    progress: {
      stopApp: "正在停止运行中的 %PRODUCT%",
  ...
  uninstall: {
    heading: "卸载 %PRODUCT%",
    sub: "这将移除 %PRODUCT% 及其注册的系统项。模型资源与用户数据将保留。",
    cancel: "取消",
    repair: "修复安装",
    uninstall: "卸载",
    close: "关闭",
...
const zhHant: InstallerStrings = {
  ...
  steps: { language: "安裝語言", mode: "安裝位置", license: "使用者協議", install: "安裝", done: "完成" },
  language: {
    title: "選擇安裝精靈的語言",
  ...
  install: {
    preparing: "正在準備安裝…",
    startedLog: "開始安裝",
    fallback: "正在安裝 %PRODUCT%，這可能需要一點時間…",
    progress: {
      stopApp: "正在停止執行中的 %PRODUCT%",
  ...
  uninstall: {
    heading: "解除安裝 %PRODUCT%",
    sub: "這將移除 %PRODUCT% 及其登錄的系統項目。模型資源與使用者資料將保留。",
    cancel: "取消",
    repair: "修復安裝",
    uninstall: "解除安裝",
    close: "關閉",
...
const en: InstallerStrings = {
  ...
  steps: { language: "Language", mode: "Location", license: "License", install: "Install", done: "Done" },
  language: {
  ...
  mode: {
    ...
    sub: "Pick the folder %PRODUCT% is installed to.",
    local: {
  ...
  install: {
    ...
    fallback: "Installing %PRODUCT% — this may take a moment…",
    progress: {
      stopApp: "Stopping the running %PRODUCT%",
    ...
    launchAfter: "Launch %PRODUCT% right after the install finishes",
    finish: "Finish",
    retry: "Retry install",
    close: "Close",
  },
  ...
  uninstall: {
    heading: "Uninstall %PRODUCT%",
    sub: "This removes %PRODUCT% and the system entries it registered. Model resources and user data are kept.",
    cancel: "Cancel",
...
const ru: InstallerStrings = {
  ...
  steps: { language: "Язык", mode: "Папка", license: "Лицензия", install: "Установка", done: "Готово" },
  language: {
  ...
  mode: {
    ...
    sub: "Укажите папку, в которую будет установлен %PRODUCT%.",
    local: {
  ...
  install: {
    ...
    fallback: "Установка %PRODUCT% — это может занять некоторое время…",
    progress: {
      stopApp: "Остановка запущенного %PRODUCT%",
    ...
    launchAfter: "Запустить %PRODUCT% сразу после установки",
    finish: "Готово",
  ...
  uninstall: {
    heading: "Удалить %PRODUCT%",
    sub: "Это удалит %PRODUCT% и зарегистрированные им системные записи. Ресурсы моделей и пользовательские данные сохранятся.",
    cancel: "Отмена",
    repair: "Восстановить",
    uninstall: "Удалить",
    close: "Закрыть",
...
const ja: InstallerStrings = {
  ...
  mode: {
    title: "インストール先を選択",
    sub: "%PRODUCT% のインストール先フォルダを選択してください。",
    local: {
      title: "この PC にインストール",
      description:
  ...
  install: {
    ...
    startedLog: "インストール開始",
    fallback: "%PRODUCT% をインストールしています。しばらくお待ちください…",
    progress: {
      stopApp: "実行中の %PRODUCT% を停止しています",
    ...
    launchAfter: "インストール完了後、すぐに %PRODUCT% を起動する",
    finish: "インストール完了",
    retry: "インストールを再試行",
    close: "閉じる",
  },
  ...
  uninstall: {
    heading: "%PRODUCT% をアンインストール",
    sub: "%PRODUCT% と、それが登録したシステム項目を削除します。モデルリソースとユーザーデータは保持されます。",
    cancel: "キャンセル",
    repair: "インストールを修復",
    uninstall: "アンインストール",
    close: "閉じる",
...
const ko: InstallerStrings = {
  ...
  mode: {
    title: "%PRODUCT% 설치 방식 선택",
    sub: "%PRODUCT%이 설치될 폴더를 선택하세요.",
    local: {
      title: "이 PC에 설치",
      description:
  ...
  install: {
    ...
    startedLog: "설치 시작",
    fallback: "%PRODUCT%를 설치하는 중입니다. 시간이 조금 걸릴 수 있습니다…",
    progress: {
      stopApp: "실행 중인 %PRODUCT%를 중지하는 중",
    ...
    launchAfter: "설치가 끝나면 바로 %PRODUCT% 실행",
    finish: "설치 완료",
    retry: "설치 다시 시도",
    close: "닫기",
  },
  ...
  uninstall: {
    heading: "%PRODUCT% 제거",
    sub: "%PRODUCT%와 등록된 시스템 항목을 제거합니다. 모델 리소스와 사용자 데이터는 유지됩니다.",
    cancel: "취소",
    repair: "설치 복구",
    uninstall: "제거",
    close: "닫기",
...
const fr: InstallerStrings = {
  ...
  steps: { language: "Langue", mode: "Emplacement", license: "Licence", install: "Installation", done: "Terminé" },
  language: {
    title: "Choisissez la langue de l'installateur",
    sub: "Les étapes suivantes s'afficheront dans la langue choisie.",
  },
  mode: {
    title: "Choisissez l'emplacement d'installation",
    sub: "Choisissez le dossier où %PRODUCT% sera installé.",
    local: {
  ...
  install: {
    ...
    fallback: "Installation de %PRODUCT% — cela peut prendre un instant…",
    progress: {
      stopApp: "Arrêt de %PRODUCT% en cours d'exécution",
      removedStale: (count) =>
    ...
    launchAfter: "Lancer %PRODUCT% dès la fin de l'installation",
    finish: "Terminer",
  ...
  uninstall: {
    heading: "Désinstaller %PRODUCT%",
    sub: "Cette opération supprime %PRODUCT% et les entrées système qu'il a enregistrées. Les ressources de modèles et les données utilisateur sont conservées.",
    cancel: "Annuler",
...
const es: InstallerStrings = {
  ...
  mode: {
    ...
    sub: "Elige la carpeta donde se instalará %PRODUCT%.",
    local: {
  ...
  install: {
    ...
    fallback: "Instalando %PRODUCT%: esto puede tardar un momento…",
    progress: {
      stopApp: "Deteniendo el %PRODUCT% en ejecución",
      removedStale: (count) =>
    ...
    launchAfter: "Iniciar %PRODUCT% nada más terminar la instalación",
    finish: "Finalizar",
  ...
  uninstall: {
    heading: "Desinstalar %PRODUCT%",
    sub: "Esto eliminará %PRODUCT% y las entradas del sistema que registró. Los recursos de modelos y los datos de usuario se conservan.",
    cancel: "Cancelar",
...
const de: InstallerStrings = {
  ...
  steps: { language: "Sprache", mode: "Installationsort", license: "Lizenz", install: "Installation", done: "Fertig" },
  language: {
  ...
  mode: {
    title: "Wählen Sie den Installationsort",
    sub: "Wählen Sie den Ordner, in dem %PRODUCT% installiert wird.",
    local: {
  ...
  install: {
    ...
    fallback: "%PRODUCT% wird installiert — das kann einen Moment dauern…",
    progress: {
      stopApp: "Laufendes %PRODUCT% wird beendet",
      removedStale: (count) =>
    ...
    launchAfter: "%PRODUCT% direkt nach Abschluss der Installation starten",
  ...
  uninstall: {
    heading: "%PRODUCT% deinstallieren",
    sub: "Damit werden %PRODUCT% und die registrierten Systemeinträge entfernt. Modellressourcen und Benutzerdaten bleiben erhalten.",
    cancel: "Abbrechen",
...
const pt: InstallerStrings = {
  ...
  mode: {
    ...
    sub: "Escolha a pasta onde o %PRODUCT% será instalado.",
    local: {
  ...
  install: {
    ...
    fallback: "A instalar o %PRODUCT% — isto pode demorar um momento…",
    progress: {
      stopApp: "A parar o %PRODUCT% em execução",
      removedStale: (count) =>
    ...
    launchAfter: "Iniciar o %PRODUCT% logo que a instalação termine",
    finish: "Concluir",
  ...
  uninstall: {
    heading: "Desinstalar o %PRODUCT%",
    sub: "Isto remove o %PRODUCT% e as entradas de sistema registadas por ele. Os recursos de modelos e os dados do utilizador são mantidos.",
    cancel: "Cancelar",
